...
def load_data_to_cassandra():
    ...
    session = cluster.connect('movies_keyspace')  # Remplacez 'movies_keyspace' par le nom de votre keyspace
    ...
    if response.status_code == 200:
        ...
        print("Les données ont été chargées avec succès dans Cassandra.")
    else:
